...
app.get("/produse",function(req, res){
    ...
    var conditieQuery="";
    if(req.query.tip){
        conditieQuery=`WHERE tipuri_produse='${req.query.tip}'`
    }
    client.query("SELECT * FROM unnest(enum_range(NULL::categ_casca))", function(err,rezOptiuni){
...
formular.parse(req, function(err, campuriText, campuriFisier ){ 
    ...
    Utilizator.getUtilizDupaUsername (campuriText.username[0],parametriCallback, 
        function(u, obparam, eroare ){ 
            let parolaCriptata=Utilizator.criptareParola();                       
            ...
            app.get("/useri", function(req, res){    
                ...
                * completam obiectComanda cu parametrii comenzii select pentru a prelua toti utilizatorii   */ 
                 ...
                 app.post("/sterge_utiliz", function(req, res){    
                    /* TO DO     in if testam daca utilizatorul din sesiune are dreptul sa stearga utilizatori    
                * completam obiectComanda cu parametrii comenzii select pentru a prelua toti utilizatorii    */
